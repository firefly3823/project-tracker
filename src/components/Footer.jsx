...
function Footer() {
    return (
       <>
            <div style={{ height: "300px" }} className='bg-dark w-100 text-black d-flex flex-wrap flex-column justify-content-center align-items-center'>
                <div className="footer-content h-100 align-items-center w-100 d-flex flex-row flex-wrap justify-content-evenly">
                    <div className="about" style={{ width: "350px" }}>
                        <Link to={'/'} className='fs-4' style={{ textDecoration: "none", color: "black", fontWeight: "bold" }}>
                            <i className="fa-brands fa-stack-overflow fa-bounce fa-2xl" style={{ paddingRight: "10px" }}></i>
                            PROJECT FAIR
                        </Link>
                    </div>
                    ...
                    <div className="Contact">
                        ...
                        <InputGroup size="sm" className="mb-3 w-100">
                            ...
                            <button type="button" style={{ backgroundColor: "black" }} className="btn btn-primary">SUBSCRIBE</button>
                        </InputGroup>
            ...
            <div className=' text-center'>Copyright © 2023 Project Fare.</div>
       </>
    )
}
